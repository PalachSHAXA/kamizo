// Vehicle management routes: list, create, update, delete, search
...
export function registerVehicleRoutes(env: Env) {
  ...
  // Vehicles: Get ALL vehicles (for staff roles only)
  ...
  // Vehicles: Search (for staff roles)
