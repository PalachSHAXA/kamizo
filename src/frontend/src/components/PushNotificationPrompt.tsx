...
export function PushNotificationPrompt() {
  ...
  if (showIOSPrompt) {
    return (
      <div className="fixed left-4 right-4 md:left-auto md:right-4 md:w-96 z-[150] animate-in slide-in-from-bottom-4 duration-300" style={{ bottom: 'max(1rem, calc(env(safe-area-inset-bottom, 0px) + 0.75rem))' }}>
