      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-xl md:text-2xl font-bold text-gray-900 truncate">{t('director.title')}</h1>
        ...
        <button
          ...
          className="btn-secondary flex items-center gap-2 min-h-[44px] touch-manipulation active:scale-[0.98] shrink-0"
        >
          <RefreshCw className={`w-4 h-4 ${isRefreshing ? 'animate-spin' : ''}`} />
          <span className="hidden sm:inline">{t('director.refresh')}</span>
        </button>
      </div>
