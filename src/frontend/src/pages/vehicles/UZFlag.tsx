...
// v118.157 — band colors corrected. Was upside-down (green top, blue bottom).
// Real flag of Uzbekistan (adopted 1991, per art. 5 of the Constitution):
//   • TOP band:    BLUE   #0099B5   (sky + water)
//   • MIDDLE band: WHITE            (peace)
//   • BOTTOM band: GREEN  #1EB53A   (fertile land)
//   • Red fimbriations between bands
//   • Crescent + 12 stars on TOP LEFT (on the blue band)
