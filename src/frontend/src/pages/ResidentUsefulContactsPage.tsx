          ...
          <div className="bg-white">
            ...
            {hasContacts && (
              <div className="flex flex-wrap justify-center gap-3 px-4 pb-4">
                {selectedAd.phone2 && (
                  <a href={`tel:${selectedAd.phone2}`} className="w-11 h-11 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors" title={`${language === 'ru' ? 'Доп. телефон' : "Qo'shimcha telefon"}: ${selectedAd.phone2}`}>
