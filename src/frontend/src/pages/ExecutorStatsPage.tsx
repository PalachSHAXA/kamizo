    ...
    <div className="space-y-6 pb-24 md:pb-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900 truncate">{language === 'ru' ? 'Статистика' : 'Statistika'}</h1>
          <p className="text-xs text-gray-500 mt-0.5 truncate">{language === 'ru' ? 'Личные показатели работы' : 'Shaxsiy ish ko\'rsatkichlari'}</p>
        </div>
      </div>
