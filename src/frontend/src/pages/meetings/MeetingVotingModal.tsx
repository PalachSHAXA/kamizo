// Sprint 16: extracted from ResidentMeetingsPage.tsx. The full voting
// flow for one meeting — agenda items with for/against/abstain, optional
// counter-proposal text, comment, and the schedule-poll vote at the top.
// Submits all agenda votes in one go via QRSignatureModal.

import { useEffect, useRef, useState } from 'react';
import {
  AlertTriangle, ArrowRight, Calendar, CheckCircle, Clock, FileText,
  Key, Loader2, MessageSquare, Minus, RefreshCw, ThumbsDown, ThumbsUp,
  Trophy, User, X,
} from 'lucide-react';
