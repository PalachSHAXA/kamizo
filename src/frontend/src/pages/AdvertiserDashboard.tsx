...
export function AdvertiserDashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto pb-24 md:pb-0">
      ...
      {/* Stats Cards */}
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 xl:gap-5 mb-6">
      ...
      {/* Coupons Modal — extracted in sprint 22 */}
      {showCouponsModal && selectedAd && (
        <CouponsModal
          adTitle={selectedAd.title}
          couponsIssued={selectedAd.coupons_issued}
          couponsActivated={selectedAd.coupons_activated}
          coupons={coupons}
          loading={loadingCoupons}
          language={language}
          onClose={() => { setShowCouponsModal(false); setSelectedAd(null); }}
        />
      )}
    </div>
  );
